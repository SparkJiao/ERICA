...
def train(args, model, train_dataloader, dev_dataloader, test_dataloader, devBagTest=None, testBagTest=None):
    ...
    if args.ckpt_to_load == "None":
        f.write("bert-base\t" + args.dataset + "\t" + str(args.train_prop) + "\t"+ args.mode + "\t" + "seed:" + str(args.seed) + "\t" + "max_epoch:" + str(args.max_epoch) + "\t" +str(time.ctime())  +"\n")
    else:
        f.write(args.ckpt_to_load + "\t" + args.dataset + "\t" + str(args.train_prop) + "\t"+ args.mode + "\t" + "seed:" + str(args.seed) + "\t" + "max_epoch:" + str(args.max_epoch) + "\t" + str(time.ctime()) +"\n")
