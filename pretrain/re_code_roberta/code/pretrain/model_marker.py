...
class CP_R(nn.Module):
    ...
    def forward(self, input, mask, label, h_pos, t_pos, input_R, mask_R, label_R, h_pos_R, t_pos_R, input_R_q, mask_R_q, label_R_q, h_pos_R_q, t_pos_R_q):
        m_loss, r_loss = self.get_loss(input, mask, label, h_pos, t_pos, 'CP')

        m_loss_R, r_loss_R, debug_2 = self.get_loss(input_R, mask_R, label_R, h_pos_R, t_pos_R, '2-hop')

        m_loss_R_q, r_loss_R_q, debug_3 = self.get_loss(input_R_q, mask_R_q, label_R_q, h_pos_R_q, t_pos_R_q, '3-hop')
