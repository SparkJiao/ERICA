...
def process_data_for_CP(data):
    ...
    if not os.path.exists("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP"):
        os.mkdir("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP")
    json.dump(list_data, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP/cpdata.json","w"))
    json.dump(rel2scope, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP/rel2scope.json", 'w'))
...
def process_data_for_MTB(data):
    ...
    if not os.path.exists("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/MTB"):
        os.mkdir("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/MTB")
    json.dump(entpair2negpair, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/MTB/entpair2negpair.json","w"))
    json.dump(entpair2scope, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/MTB/entpair2scope.json", "w"))
    json.dump(list_data, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/MTB/mtbdata.json", "w"))
...
def process_data_for_CP_R(data):
    ...
    if not os.path.exists("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R"):
        os.mkdir("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R")
    json.dump(list_data, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R/cpdata.json","w"))
    json.dump(rel2scope, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R/rel2scope.json", 'w'))
    json.dump(ent2sen, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R/ent2sen.json", 'w'))
    json.dump(r_map_t, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R/r_map_t.json", 'w'))
    json.dump(r_map_q, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R/r_map_q.json", 'w'))
    json.dump(relation2sen_soft_t, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R/relation2sen_soft_t.json", 'w'))
    json.dump(relation2sen_soft_q, open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/CP_R/relation2sen_soft_q.json", 'w'))
...
if __name__ == "__main__":
    ...
    if args.dataset == "cp":
        data = json.load(open("/mnt/yardcephfs/mmyard/g_wxg_td_prc/yujiaqin/REAnalysis/data/exclude_fewrel_distant.json"))
